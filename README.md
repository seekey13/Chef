...
- **Left-click** the icon for a menu of the food in your inventory with their stack counts; picking one runs `/item "<name>" <me>`. Hovering an entry shows its in-game description. **Open Store** at the bottom runs `!chef`. The menu closes on either.
