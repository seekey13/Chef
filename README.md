...
- **Left-click** the icon for a menu of the usable items in your inventory with their stack counts; picking one runs `/item "<name>" <me>`. **Open Store** at the bottom runs `!chef`. The menu closes on either.
